...
// List
$GLOBALS['TL_DCA']['tl_content']['list']['sorting']['child_record_callback'] = array('tl_content_mobilelayout', 'addCteTypeWithMobileVisibility');
...
class tl_content_mobilelayout extends tl_content {
  /**
